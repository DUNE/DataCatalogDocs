...
Minimal terms for raw and processed data
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
:parents:  [The files that this file was produced from, you need to declare parents when declaring child files]
...
:core.data_tier: type of data, generally indicates steps in a processing sequence (raw, g4, )
...
:*core.events*: [list of events in the file], not useful for multiple runs
